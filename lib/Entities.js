...
function Snake(conn, start_x, start_y) {
    ...
    this.blocks.push(new GameObject([this.connection], 'snake_head', start_x, start_y));
    this.blocks.push(new GameObject([this.connection], 'snake_body', start_x, start_y-1*this.block_size));
    this.blocks.push(new GameObject([this.connection], 'snake_body', start_x, start_y-2*this.block_size));
}
