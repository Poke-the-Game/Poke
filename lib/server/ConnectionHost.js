...
/**
 * Represents a host for a list of game-related connections.
 * @param {SocketIO.Pool} io - Socket.IO Server connection.
 * @class
 * @alias Poke.server.ConnectionHost.ConnectionHost
 */
...
/**
 * Starts a Game on this ConnectionHost Instance.
 * @param {SocketIO.Client} player1 - First player.
 * @param {SocketIO.Client} player2 - Second player.
 * @param {string} game_type - Game Type to play. 
 */
